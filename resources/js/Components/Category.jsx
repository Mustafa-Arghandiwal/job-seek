...
export default function Category(props) {
    return (
        <div className=" min-w-[180px] shadow-lg cursor-pointer border border-primary-50 hover:border-primary-300 transition-all duration-100  rounded-xl grid place-items-center gap-6  py-8 snap-center">
