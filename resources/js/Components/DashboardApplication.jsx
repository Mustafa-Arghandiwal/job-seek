...
export default function DashboardApplication(props) {
    ...
    if (isDragging) {
        return (
            <div ref={setNodeRef} style={style} className="w-[272px] h-[218px] bg-white opacity-50 rounded-sm p-4 mt-3">
    ...
    return (
        ...
        <div ref={setNodeRef} style={style} {...attributes} {...listeners} className="w-[272px] h-[218px] bg-white rounded-sm p-4 mt-3 cursor-grab"
