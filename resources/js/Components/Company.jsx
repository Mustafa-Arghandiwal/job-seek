...
export default function Company(props) {
    ...
    return (
        <div className="flex flex-col justify-between   sm:gap-8 border h-[215px] sm:h-auto border-customGray-50 rounded-xl p-6 sm:p-8 max-w-[300px] sm:min-w-[290px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] hover:shadow-xl duration-150 snap-center">
                ...
                <div className="flex flex-col gap-1.5">
                    <div className="flex justify-center items-center gap-2  flex-wrap">
                        <div className="h-[58px]  max-w-full">
                            <h4 title={props.companyName} className="text-[#191F33] font-medium text-base sm:text-lg line-clamp-2">{props.companyName}</h4>
                            ...
                            <div className="flex items-center gap-1 text-[#5E6670] text-sm mt-1"><img src="map-pin.png" className="h-4" />{props.companyLocation}</div>
                        </div>
                    </div>
                </div>
            </div>
