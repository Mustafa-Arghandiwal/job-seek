    ...
    return (
        <div className="relative grid grid-cols-[auto_1fr] grid-rows-[1fr_auto]  h-[calc(100dvh-138px-40px)] overflow-hidden px-1 xl:px-[150px] 2xl-px-[230px] ">
            ...
            <nav className={`text-nowrap relative flex flex-col pt-6  border-r border-r-customGray-100 ${isOpen ? 'w-[200px]' : 'w-16'} duration-300`}>
                ...
                <h2 className={` text-customGray-400 font-medium text-xs px-6 mb-3 invisible md:visible`}>EMPLOYER DASHBOARD</h2>
                ...
                <Link href="/employer/dashboard/post-job" className={` ${url === '/employer/dashboard/post-job' ? 'before:h-full bg-primary-50 text-primary-500 hover:bg-primary-50 hover:text-primary-500 ' : 'before:h-0'} relative group before:absolute before:bg-primary-500 before:left-0 before:w-1 before:top-0   flex gap-4 items-center px-5 py-3 text-customGray-500 text-sm font-medium hover:text-customGray-900 hover:bg-customGray-50 before:rounded-4xl before:duration-150 before:ease-in-out `}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                    ...
                    <span className={`${(!isOpen) && 'w-0 overflow-hidden'}`}>Post a Job</span>
                ...
                <Link href="/employer/dashboard/my-jobs" className={` ${url === '/employer/dashboard/my-jobs' ? 'before:h-full bg-primary-50 text-primary-500 hover:bg-primary-50 hover:text-primary-500 ' : 'before:h-0'} relative group before:absolute before:bg-primary-500 before:left-0 before:w-1 before:top-0   flex gap-4 items-center px-5 py-3 text-customGray-500 text-sm font-medium hover:text-customGray-900 hover:bg-customGray-50 before:rounded-4xl before:duration-150 before:ease-in-out `}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                    ...
                    <span className={`${(!isOpen) && 'w-0 overflow-hidden'}`}>My Jobs</span>
                ...
                <Link href="/employer/dashboard/saved-candidates" className={` ${url === '/employer/dashboard/saved-candidates' ? 'before:h-full bg-primary-50 text-primary-500 hover:bg-primary-50 hover:text-primary-500 ' : 'before:h-0'} relative group before:absolute before:bg-primary-500 before:left-0 before:w-1 before:top-0   flex gap-4 items-center px-5 py-3 text-customGray-500 text-sm font-medium hover:text-customGray-900 hover:bg-customGray-50 before:rounded-4xl before:duration-150 before:ease-in-out `}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
                    ...
                    <span className={`${(!isOpen) && 'w-0 overflow-hidden'}`}>Saved Candidates</span>
                ...
                <Link href="/employer/dashboard/settings" className={` ${url === '/employer/dashboard/settings' ? 'before:h-full bg-primary-50 text-primary-500 hover:bg-primary-50 hover:text-primary-500 ' : 'before:h-0'} relative group before:absolute before:bg-primary-500 before:left-0 before:w-1 before:top-0   flex gap-4 items-center px-5 py-3 text-customGray-500 text-sm font-medium hover:text-customGray-900 hover:bg-customGray-50 before:rounded-4xl before:duration-150 before:ease-in-out `}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
