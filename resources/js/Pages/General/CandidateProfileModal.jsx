                    ...
                    <div className="py-8  flex items-center flex-wrap gap-4 justify-center xs:justify-between ">
                        ...
                        <div className="">
                            <div className="flex gap-1 xs:gap-3 flex-col items-center xs:flex-row">
                                ...
                                <a href={`mailto:${email}`} className="group flex gap-2 rounded-sm font-semibold text-white bg-primary-500 hover:bg-primary-600 cursor-pointer px-6 py-3 duration-150 text-nowrap">
