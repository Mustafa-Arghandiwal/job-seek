...
export default function SocialLinksTabContent() {
    ...
    return (
        <form className="flex flex-col gap-6">
            ...
            <button type="button" className="flex justify-center items-center text-sm  gap-2 text-gray-900 bg-customGray-50 rounded-md py-3 px-2 cursor-pointer hover:bg-primary-500 hover:text-white duration-75" >
