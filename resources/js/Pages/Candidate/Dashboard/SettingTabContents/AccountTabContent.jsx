        ...
        <div className="relative">
            ...
            <form className="" onSubmit={handleContactFormSubmit}>
                ...
                <div className="flex flex-col md:flex-row gap-2 md:gap-6  mt-5">
                    ...
                    <div className="flex flex-col gap-2  max-w-96 w-full md:w-1/2 relative">
                        <label htmlFor="email" className="text-sm text-customGray-900 flex">Contact Email <Asterisk className="w-3 h-3 text-danger-500 "/></label>
                ...
                <div className="flex flex-wrap mt-8  items-center gap-2">
                    ...
                    <span className={`text-success-500  h-6 w-52 sm:w-auto text-sm ${contactSuccessMsg ? 'opacity-100' : 'opacity-0'}  transition-all duration-300 `}>
                        {contactSuccessMsg}
                    </span>
                </div>
            </form>
