                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <div className="relative ">
                            ...
                            onClick={() => setDropdownVisible(prev => !prev)}>
                                {data.role} <img ref={caret} className={`w-3.5 transition-all duration-200 ${dropdownVisible ? "rotate-180" : ""}`} src="CaretDown.svg" />
                            </button>
                                
                            
                                <div className={`absolute shadow-[0px_12px_32px_rgba(25,31,51,0.08)] z-10 top-full flex flex-col w-full border border-gray-100 rounded-md p-3 text-sm text-gray-700 ${dropdownVisible ? "opacity-100 translate-y-0 visible" : "opacity-0 -translate-y-3 invisible"}  transition-all duration-300 ease-in-out`}>
