...
Route::middleware(['auth', 'verified', EnsureCandidate::class])->group(function () {
    ...
    Route::get('/candidate/dashboard/overview', [CandidateSettingsController::class, 'dashboardOverview']);
    ...
    Route::get('/candidate/settings/profile/resumes/{resume_id}', [ResumeController::class, 'show']);
...
Route::middleware(['auth', 'verified', EnsureEmployer::class])->group(function () {
    ...
    Route::post('/employer/vacancies/{vacancy}/applications/updateShortlistStatus', [ApplicationController::class, 'shortlist']);
